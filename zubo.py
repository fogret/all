...
# ==================== 主函数 只修复【执行顺序卡死bug】 其余全部原版不动 ====================
def main():
    # 第一步：先把所有省份IP扫描 完整跑完，才往下走
    print("========== 开始全国各省IP扫描 ==========")
